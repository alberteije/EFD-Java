...
@NamedQueries({
    @NamedQuery(name = "EcfFechamentoVO.findAll", query = "SELECT e FROM EcfFechamentoVO e")})
public class EcfFechamentoVO implements Serializable {
    ...
    public EcfFechamentoVO(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EcfFechamentoVO)) {
            return false;
        }
        EcfFechamentoVO other = (EcfFechamentoVO) object;
    ...
    public String toString() {
        return "javaapplication7.EcfFechamentoVO[ id=" + id + " ]";
    }
