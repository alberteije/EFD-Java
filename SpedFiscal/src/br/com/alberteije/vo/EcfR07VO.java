...
@Table(name = "ecf_r07")
@NamedQueries({
    @NamedQuery(name = "EcfR07VO.findAll", query = "SELECT e FROM EcfR07VO e")})
public class EcfR07VO implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EcfR07VO)) {
            return false;
        }
        EcfR07VO other = (EcfR07VO) object;
    ...
    public String toString() {
        return "javaapplication7.EcfR07VO[ id=" + id + " ]";
    }
