...
@NamedQueries({
    @NamedQuery(name = "EcfSangriaVO.findAll", query = "SELECT e FROM EcfSangriaVO e")})
public class EcfSangriaVO implements Serializable {
    ...
    public EcfSangriaVO(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EcfSangriaVO)) {
            return false;
        }
        EcfSangriaVO other = (EcfSangriaVO) object;
    ...
    public String toString() {
        return "javaapplication7.EcfSangriaVO[ id=" + id + " ]";
    }
