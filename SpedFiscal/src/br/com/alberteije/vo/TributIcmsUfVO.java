...
@NamedQueries({
    @NamedQuery(name = "TributIcmsUfVO.findAll", query = "SELECT t FROM TributIcmsUfVO t")})
public class TributIcmsUfVO implements Serializable {
    ...
    public TributIcmsUfVO(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TributIcmsUfVO)) {
            return false;
        }
        TributIcmsUfVO other = (TributIcmsUfVO) object;
    ...
    public String toString() {
        return "javaapplication7.TributIcmsUfVO[ id=" + id + " ]";
    }
