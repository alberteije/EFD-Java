...
@NamedQueries({
    @NamedQuery(name = "TributPisCodApuracaoVO.findAll", query = "SELECT t FROM TributPisCodApuracaoVO t")})
public class TributPisCodApuracaoVO implements Serializable {
    ...
    public TributPisCodApuracaoVO(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TributPisCodApuracaoVO)) {
            return false;
        }
        TributPisCodApuracaoVO other = (TributPisCodApuracaoVO) object;
    ...
    public String toString() {
        return "javaapplication7.TributPisCodApuracaoVO[ id=" + id + " ]";
    }
